    ...
    >
      <div className="max-w-[900px] mx-auto text-center px-6">
        ...
        <ScrollReveal variant="blur" delay={100}>
          <h3 className="font-display text-[clamp(2.25rem,6vw,5rem)] text-pure-white leading-[0.95] mb-6">
            FEATURED ON REALLY GOOD EMAILS.
          </h3>
        </ScrollReveal>

        <ScrollReveal variant="fade-up" delay={200}>
          <span className="meta-label text-foreground/50 mb-6 block leading-relaxed">
            ALONGSIDE NIKE · CHIPOTLE · GYMSHARK — AND 10,000+ OF THE BEST EMAILS ON THE INTERNET
          </span>
        </ScrollReveal>
